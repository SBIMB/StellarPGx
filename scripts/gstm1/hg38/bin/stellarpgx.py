...
print("GSTM1 Star Allele Calling with StellarPGx\n")
...
if cn == '2':
    ...
    if "or" in snv_def_alleles and del_confirm == 'None':
        print (snv_def_alleles + "\t" + "Possible GSTM1 gene deletion present")
    ...
    print("Possible rare GSTM1 structural variant present")
