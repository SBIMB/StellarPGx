...
print("NUDT15 Star Allele Calling with StellarPGx\n")
...
cov_int2_e3 = get_total_CN(cov_file)[4]
...
if cn == '2':
    ...
    if 'or' in snv_def_alleles:        
        ...
        if snv_def_alleles[0] == '*1' or snv_def_alleles[1] == '*1':
            ...
            test_sv1 = hybrid_sv1_test1(cov_e1_int2, cov_int2_e3)
            test_new_hyb = hybrid_new_test1(cov_e1_int2, cov_int2_e3)


            if test_sv1 == 'norm_var' and test_new_hyb == 'norm_var':
                gene_alleles = "/".join(snv_def_alleles)
                print(gene_alleles)

            elif test_sv1 == 'hyb_sv1':
                gene_alleles = snv_def_alleles[ind_other] + "/" + "*sv1"
                print(gene_alleles)

            elif test_sv1 == 'hyb_sv1_2' and snv_def_alleles == "*1/*1":
                gene_alleles = "*sv1/*sv1"
                print(gene_alleles)
    ...
    if del_confirm == '*(full_gene_del)/*(full_gene_del)':
        gene_alleles = '*sv2/*sv2'
        print (gene_alleles)
        
    elif del_confirm == '*(full_gene_del)':
        gene_alleles = '*sv2' + "/" + "*other"
        print(gene_alleles)
    ...
    if "or" in snv_def_alleles and del_confirm == 'None':
        print (snv_def_alleles + "\t" + "Possible NUDT15 gene deletion present")
        ...
        if snv_def_alleles[0] == snv_def_alleles[1]:
            gene_alleles = snv_def_alleles[0] + "/" + "*sv2"
            print(gene_alleles)
    ...
    print("Possible rare NUDT15 hybrid present")
