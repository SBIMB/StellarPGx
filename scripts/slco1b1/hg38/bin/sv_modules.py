...
def get_total_CN(cov_file):
    ...
    av_slco1b1_cov = float(all_reg[0][3])/(float(all_reg[0][2]) - float(all_reg[0][1]))
    ...
    av_e1_int2 = float(all_reg[3][3])/(float(all_reg[3][2]) - float(all_reg[3][1]))
    av_int7_e16 = float(all_reg[4][3])/(float(all_reg[4][2]) - float(all_reg[4][1]))

    av_ctrl_cov = (av_vdr_cov + av_egfr_cov)/2

    comp_av = av_slco1b1_cov/av_ctrl_cov
    temp_cn = 2 * comp_av
    total_cn = round(temp_cn)


    return [str(int(total_cn)), round(av_slco1b1_cov), round(av_ctrl_cov), str(av_e1_int2), str(av_int7_e16)];
...
def hybrid_49_test1(cov_e1_int2, cov_int7_e16):

    if 0.85 < float(cov_e1_int2)/float(cov_int7_e16) < 1.2:
        return 'norm_var'

    elif 0.45 < float(cov_e1_int2)/float(cov_int7_e16) < 0.75:
        return 'hyb_49'

    elif float(cov_e1_int2)/float(cov_int7_e16) < 0.15:
        return 'hyb_49_2'
...
def hybrid_new_test1(cov_e1_int2, cov_int7_e16):

    if 0.85 < float(cov_e1_int2)/float(cov_int7_e16) < 1.2:
        return 'norm_var'

    elif 0.45 < float(cov_int7_e16)/float(cov_e1_int2) < 0.75:
        return 'hyb_new'

    elif float(cov_int7_e16)/float(cov_e1_int2) < 0.15:
        return 'hyb_new_2'
